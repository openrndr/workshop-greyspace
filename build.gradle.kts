...
val orxVersion = if (orxUseSnapshot) "0.4.0-SNAPSHOT" else "0.3.39"

// supported features are: orx-camera, orx-compositor,orx-easing, orx-filter-extension,orx-file-watcher,
// orx-integral-image, orx-interval-tree, orx-jumpflood, orx-kdtree, orx-mesh-generators,orx-example.midi, orx-no-clear,
// orx-noise, orx-obj, orx-olive, orx-osc

val orxFeatures = setOf("orx-noise", "orx-midi", "orx-osc")
